    ...
    <v-navigation-drawer persistent :mini-variant="miniDrawer" v-model="showDrawer" fixed app>
      <v-layout column fill-height>
        ...
        <v-list subheader v-show="hasAdminAccess">
          <v-subheader>This</v-subheader>

          <v-list-tile to="/main/tickets">
            <v-list-tile-action>
              <v-icon>list</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
          ...
          <v-list-tile to="/main/tickets/create">
            <v-list-tile-action>
              <v-icon>add</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Create Ticket</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
